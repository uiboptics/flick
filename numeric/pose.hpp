...
public:
  ...
  const vector &operator()() const { return v_; }
...
public:
  ...
  const position &get_position() const { return p_; }
  const rotation &get_rotation() const { return r_; }
  ...
  unit_vector x_direction() const { return r_.x_direction(); }
  unit_vector y_direction() const { return r_.y_direction(); }
  unit_vector z_direction() const { return r_.z_direction(); }
...
public:
  ...
  // applied to reach this pose.
  {
    pose p = *this;
    vector v =
        rotate(position_ - observer.position(), inv(observer.rotation()));
    p.move_to(v);
  ...
  unit_vector direction() const { return z_direction(); }
